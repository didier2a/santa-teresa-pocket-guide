...
test('V1.4.5: les POST Vercel utilisent text/plain pour éviter le preflight CORS',async()=>{
  ...
  assert.doesNotMatch(js,/Content-Type':'application\/json/);
  assert.match(html,/studio-v1-4\.js\?v=1\.4\.5/);
});

test('V1.4.5: backend health et URL Vercel sont configurés',async()=>{
...
test('V1.4.5: AI Planner passe par Responses API, web search et validateur',async()=>{
