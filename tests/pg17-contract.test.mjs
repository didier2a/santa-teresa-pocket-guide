...
test('V1.7 revisioned imports bypass an already installed stale service worker',()=>{assert.match(html,/app-entry\.js\?v=1\.7\.0rc2/);assert.match(entry,/app-enhancer\.js\?v=1\.7\.0rc2/);});
