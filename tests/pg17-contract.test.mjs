...
test('missing planned media degrades safely and can be enriched from attributed Commons results',()=>{assert.match(enhancer,/findCommonsImages/);assert.match(enhancer,/route\.media\.enriched/);assert.match(enhancer,/imageAttribution/);assert.match(sw,/route-media\.js/);});
