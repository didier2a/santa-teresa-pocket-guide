const SHELL_IDENTITY='PocketGuide 2.3.1';
const reclaimShellIdentity=()=>{
  ...
  const title='PocketGuide V2.3.1 · Compagnon vivant';
...
await import('../../pg22/bootstrap/app.js?v=2.3.1.2');
const {installLivingCompanion}=await import('./living-companion-runtime.js?v=2.3.1.2');
