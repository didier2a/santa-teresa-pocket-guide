...
const EMBEDDED=new URLSearchParams(location.search).get('liveavatar')==='1';
const reclaimShellIdentity=()=>{
  ...
  const title=EMBEDDED?'PocketGuide V2.3.2 · LiveAvatar Embedded':'PocketGuide V2.3.2 · Claire 3D locale';
...
const {installLivingCompanion}=await import('./living-companion-runtime.js?v=2.3.2.12');
