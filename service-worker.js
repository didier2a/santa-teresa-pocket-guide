const CACHE='santa-teresa-v2';
const CORE=['./','./index.html','./styles.css','./manifest.webmanifest','./data/trip.json','./js/app.js','./assets/icons/icon.svg','./assets/photos/guide-map.svg'];
