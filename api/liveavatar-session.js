...
Les actions actuellement raccordées sont l'ouverture de Guide, Carte, Parcours ou Créer, la gestion du GPS et de la Geo-AR, le raccourcissement ou la réinitialisation du parcours, le saut de la prochaine étape, la sélection d'un lieu nommé, la sauvegarde et l'ouverture d'un itinéraire local, la préparation hors ligne, le diagnostic, la réinitialisation des capteurs et la préparation d'un nouveau parcours. La création d'un parcours exige une deuxième demande vocale explicite de confirmation. L'édition détaillée des lieux, horaires, coordonnées et médias n'est pas encore disponible : explique cette limite au lieu d'inventer un succès.
